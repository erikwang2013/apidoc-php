...
<a href="https://packagist.org/packages/erik/apidoc"><img src="https://img.shields.io/packagist/dd/erik/apidoc"></a>
<a href="https://packagist.org/packages/erik/apidoc"><img src="https://img.shields.io/packagist/l/erik/apidoc"></a>
<a href="https://github.com/erik/apidoc-php"><img src="https://img.shields.io/github/issues/erik/apidoc-php"></a>
<a href="https://github.com/erik/apidoc-php"><img src="https://img.shields.io/github/forks/erik/apidoc-php"></a>
...
Apidoc是一个通过解析attributes（属性）生成Api接口文档的PHP composer扩展，兼容Laravel、ThinkPHP、Hyperf、Webman等框架；
全面的attributes（属性）引用、数据表字段引用，简单的attributes（属性）即可生成Api文档，而Apidoc不仅于接口文档，在线接口调试、Mock调试数据、调试事件处理、Json/TypeScript生成、接口生成器、代码生成器等诸多实用功能，致力于提高Api接口开发效率。
...
- [Github](https://github.com/erik/apidoc-php) -> <a href="https://github.com/erik/apidoc-php" target="_blank">
  <img height="22" src="https://img.shields.io/github/stars/erik/apidoc-php?style=social" class="attachment-full size-full" alt="Star me on GitHub" data-recalc-dims="1" /></a>
